export const BUTTONS = [
  ...
  { label: '÷', class: 'operation-button', action: 'performDivision' },
  ...
  { label: 'x', class: 'operation-button', action: 'performMultiplication' },
  ...
  { label: '-', class: 'operation-button', action: 'performSubtraction' },
  ...
  { label: '+', class: 'operation-button', action: 'performAddition' },
